...
const EmployeeStats = () => {
    ...
    const getStatsByPayGroup = () => {
        const stats = {};
        // Use all employees for the distribution chart but highlight filtered ones? 
        // Actually, usually charts reflect the filtered set.
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '24px', marginBottom: '24px' }}>
                ...
                <div className="card">
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        {pgStats.length > 0 ? pgStats.map(([name, count]) => (
                ...
                <div className="card">
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                        {desigStats.length > 0 ? desigStats.map(([name, count]) => (
                            <div key={name} style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '13px' }}>
                                    <span style={{ fontWeight: 500 }}>{name}</span>
                                    <span style={{ fontWeight: 600 }}>{count} employees</span>
